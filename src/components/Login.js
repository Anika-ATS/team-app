...
export const Login = () => {
  ...
  return (
    <>
    <section className="bg-gray-50 min-h-screen flex items-center justify-center z-40 drop-shadow-2xl ">
     <div className=" bg-gray-100 flex w-3/4 mt-0 rounded-2xl shadow-lg max-w-screen p-5 justify-between ">
      ...
      {/* button */}
      <button className="py-2 mt-3  rounded-xl border bg-gradient-to-r from-purple-300 to-purple-600 text-white   hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 " type="submit" >Login</button>
     </form>
