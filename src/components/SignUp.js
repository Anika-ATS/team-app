...
export const SignUp = () => {
  ...
  return (
    <>
    <p className='font-bold text-2xl p-5  text-center'> Please <span className='italic text-red-700 '>Sign Up</span> First </p>
    <section className="bg-white min-h-screen flex items-center justify-center z-40 ">
     ...
     <form className="flex flex-col gap-4" action="" onSubmit={submitForm}>
        {/* Name */}
        <label className="font-bold " for="exampleInputEmail1" class="form-label">Name: </label>
        ...
        />
        {/* Password */}
        <label className="font-bold "  class="form-label">Password: </label>
        ...
        />
        {/*Confirm Password */}
        <label className="font-bold "  class="form-label">Confirm Password: </label>
        ...
        <label className="font-bold "  class="form-label">Phone Number: </label>
        ...
        <label className="font-bold "  class="form-label">Height: </label>
      ...
      <button className="py-2 mt-3  rounded-xl border bg-purple-600 text-white   hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 " type="submit" >SignUp</button>
     </form>
     <p className="font-bold text-xl p-2"> Allready Have An Account ? <br/>Let's  
     <Link to="/Login"><span className="text-red-700 italic"> Sign in!!</span></Link></p>
     </div>
     {/* img div */}
     <div className="sm:block hidden bg-purple-600 w-3/4  rounded-2xl">
